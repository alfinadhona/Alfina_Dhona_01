...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1">Savory Admin</a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="<?= base_url('cafe/index') ?>">
...
<ul class="sidebar navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="<?= base_url('cafe/tambah') ?>">
            <i class="zvz"></i>
    ...
    <div class="card-body">
        ...
        <p class="card-text"><?= $pelanggan['id_meja']; ?></p>
        <!-- <p class="card-text"><?= $pelanggan['person']; ?></p> -->
        <p class="card-text"><?= $pelanggan['datetime']; ?></p>
        <a href="<?= base_url('cafe/index') ?>" class="btn btn-primary">Kembali</a>
    </div>
    </div>
    </div>
</div>
